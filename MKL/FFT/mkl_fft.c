...
/*
 * $$$$$$ LRZ WORK FOR YOU : Uncomment 2 lines below  $$$$$$$$$
 */
#include <offload.h>
...
#include "mkl.h"
/*
 * $$$$$$$$  LRZ WORK FOR YOU: Uncomment 1 line below   $$$$$
 */
...
int main(void)
{
    ...
    /*
     * $$$$$$   LRZ WORK FOR YOU: Use offload pragma to preallocate memory for x on the target.
    ...
    /* 
     * $$$$$$   LRZ WORK FOR YOU: Offload the call to DftiCreateDescriptor to the target.
    ...
    /* 
     * $$$$$   LRZ WORK FOR YOU: Offload the call to DftiComputeForward to the target.
	...
	time_start = dsecnd();
    /* 
     * $$$$ LRZ WORK FOR YOU: Offload the call to DftiComputeBackward to the target.
     *      (1) Make sure x is an 'inout' variable, because this is in-place
     *      transform.
     *      (2) Do not allocate memory for x because it was preallocated.
    ...
    /*
     * $$$$ LRZ WORK FOR YOU: Use offload pragma to deallocate memory of x on the target.
